<template>
  <div id="navbar">
    <div
      class="flex flex-row justify-between items-center m-auto w-full max-w-7xl"
    >
      <nuxt-link to="/">
...
#navbar {
  @apply z-50 sticky top-0 w-full py-3 border-b border-slate-900/10 backdrop-blur-md bg-white/10;
}
